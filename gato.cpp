...
int main(int argc, char* argv[])
{
   ...
   if(!cont)
   cout<<" LA PARTIDA ACABA EN ENPATE "<<endl;
...
printf(" \n");
printf("PASO 1: Elige la casilla donde quieres poner tu simbolo. \n");
printf(" \n");
printf("PASO 2: Debes poner el numero de 2 digitos para que ahi se coloque tu simbolo. \n");
printf(" \n");
printf("PASO 3: El primer digito debe ser del 0 a 2 de lado a lado. \n");
printf(" \n");
printf("PASO 4: EL segundo digito debe ser igual del 0 a 2 de arriba abajo. \n");
printf(" \n");
printf("PASO 5: Presiona ENTER y listo tu simbolo esta en la casilla. \n");
printf(" \n");
printf("EMPEZEMOS A JUGAR \n");
    ...
    {
        if(tabla[0][0].X==1)
        printf("%c%c%c%c%c",186,32,88,32,186);
        else
        printf("%c%c%c%c%c",186,32,79,32,186);
    }
        else
        printf("%c%c%c%c%c",186,32,32,32,186);
